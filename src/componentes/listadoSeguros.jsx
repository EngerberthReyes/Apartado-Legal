...
} from "./notificaciones/notificaciones-amarillas-dos.jsx";
import {
  VisualizarContrato,
  EditarContrato,
  EliminarContrato,
} from "./RUD/visualizar-editar-eliminar-dos.jsx";
...
console.log(contratoDataFiltrado)
      contratoData = contratoDataFiltrado;
       ...
       if (alteracion === "editarcontrato") {
        ...
        contratoData.map(async (elementoSeguro) => {
          if (elementoSeguro.id_contrato === id && elementoSeguro.id_tipo_contrato > 3) {
            await axios.get(`http://localhost:3000/api/ctss_contratos/${id}`);
            setElementoSeleccionado([elementoSeguro]);
            setVisualizar(true);
            setEditar([]);
            setEliminar([]);
            handleClick();
                  ...
                  <table className={`tabla ${styles.tabla}`}>
                    <thead className={styles.thead}>
                      <tr className={styles.tr}>
                        <th className={styles.th}>Seguro Contratado</th>
                  ...
                  >
                    ...
                    <tbody className={styles.cuerpoTabla}>
                      <tr>
                        ...
                        >
                          Sin Registro de Contratos en Seguros...
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <>
                <table className={`tabla ${styles.tabla}`}>
                  <thead className={styles.thead}>
                    ...
                    >
                      <th className={styles.th}>Seguro Contratado</th>
                      <th className={styles.th}>Tipo de Seguro Contratado</th>
                      <th className={styles.th}>Fecha de Inicio</th>
                      <th className={styles.th}>Fecha de Fin</th>
                      {!contenedorTabla?.classList.contains(
                        `${styles.contenedorTablaGeneral}`
