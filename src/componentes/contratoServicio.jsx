...
const resolverPeticion = await axios.post(urlSubidaImagen, formularioImagen, {
    headers: {
      ...
      const datosRecibidos = { ...datos, firma_paquete_turistico: `http://localhost:3000/${imagenDos.name}`, tipo_contrato: opcionServicio }
              ...
              <section>
                <section className={stylesContrato.sectionParteUno}>
                  ...
                  <p className={stylesContrato.p}>
                    ...
                    hospedaje de alta calidad para los huéspedes. Los servicios
                    de hospedaje incluyen:
                  </p>
                  <ul>
                    <li>Alojamiento.</li>
                    <li>Limpieza.</li>
    ...
    <li>
        Atención al cliente: El Transportista proporcionará un servicio al cliente profesional y cortés, atendiendo cualquier consulta o necesidad que los pasajeros puedan tener durante el viaje.
                ...
                <section className={stylesContrato.sectionParteUno}>
                  ...
                  <p className={stylesContrato.p}>
                    Este servicio ofrece una cantidad máxima de personas a
                    alojar en el medio transporte o vehiculo en el cual se transportara a los pasajeros es de:
                    <input
                      placeholder="Cantidad Maxima de Personas"
                      className={stylesContrato.inputTexto}
                      type="number"
...
<p className={stylesContrato.p}>
    El Prestador se compromete a proporcionar servicios de alimentación de alta calidad para los clientes. Los servicios de alimentación incluyen:
</p>
