...
import ContratoServicio from "@/componentes/contratoServicio.jsx";
import ContratoSeguro from "@/componentes/contratoSeguro.jsx";
        ...
        {opcionSeleccionada === "Tipo de Contrato" && (
          <section className={stylesContrato.seleccionasa}>
            <h1 style={{ fontSize: "36px", textAlign: "center" }}>
              Seleccione Hacia Donde irá Dirigido Contrato, Si Hacia un Servicio
              o Hacia un Seguro
            </h1>
          </section>
        )}
